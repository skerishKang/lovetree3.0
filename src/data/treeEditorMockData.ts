  ...
  memories: [
    {
      ...
      date: "2023.10.15", typeLabel: "비디오", mediaFormat: "MP4 1080p", source: "직캠 촬영", duration: "3분 24초",
      youtubeUrl: "https://www.youtube.com/watch?v=jNQXAC9IVRw", thumbnailColorKey: "sky",
      tags: ["#기억", "#추억", "#팬미팅"], parentId: null, childIds: ["mem-2"],
    },
    {
      id: "mem-2", title: "대기실 준비", description: "무대 오르기 전 대기실 분위기와 긴장감",
      date: "2023.10.15", typeLabel: "비디오", mediaFormat: "MP4 720p", source: "백스테이지 녹화", duration: "1분 48초",
      youtubeUrl: "https://youtu.be/dQw4w9WgXcQ", thumbnailColorKey: "rose",
    ...
    },
    {
      ...
      date: "2023.10.13", typeLabel: "비디오", mediaFormat: "MP4 1080p", source: "리허설 녹화", duration: "2분 12초",
      youtubeUrl: "https://www.youtube.com/shorts/aqz-KE-bpKQ", thumbnailColorKey: "sage",
      tags: ["#무대", "#첫인사", "#리허설"], parentId: "mem-2", childIds: ["mem-5"],
    },
    {
      id: "mem-5", title: "앙코르 무대", description: "마지막 곡의 여운, 관객과 함께한 엔딩",
      date: "2023.10.12", typeLabel: "비디오", mediaFormat: "MP4 4K", source: "공식 촬영", duration: "4분 05초",
      youtubeUrl: "https://www.youtube-nocookie.com/embed/jNQXAC9IVRw", thumbnailColorKey: "coral",
