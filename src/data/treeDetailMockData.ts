...
export const MOCK_TREE_DETAIL: TreeDetailData = {
  ...
  memories: [
    ...
    {
      id: "mem-2", date: "2023-10-15", title: "첫 앨범 구매 인증",
      description: "첫 앨범을 샀던 날. 한정판이라서 예약 주문했는데 드디어 도착했어요.",
      tags: ["앨범", "첫구매"], emoji: "💿", side: "bottom",
      typeLabel: "음반 수집", mediaLabel: "실물 앨범 사진", locationLabel: "레코드샵 앞",
    ...
    {
      id: "mem-4", date: "2024-01-07", title: "컴백 D-Day",
      description: "기다리고 기다리던 컴백! 신곡을 처음 들었을 때의 전율.",
      tags: ["컴백", "신곡"], emoji: "🌟", side: "bottom",
      typeLabel: "신보 발매", mediaLabel: "음원 스트리밍", locationLabel: "실시간 차트 스크린샷",
      reactionCount: 64, connectionLabel: "신곡 분석과 무한 반복", isFeatured: false, accentVariant: "amber",
    },
    {
      id: "mem-5", date: "2024-02-14", title: "팬미팅 후기",
      description: "발렌타인데이 팬미팅. 멤버들한테 직접 편지를 전달했어요.",
      tags: ["팬미팅", "후기"], emoji: "💌", side: "top",
      typeLabel: "오프라인 팬미팅", mediaLabel: "손편지 & 티켓 인증", locationLabel: "경희대 평화의전당",
      reactionCount: 77, connectionLabel: "양방향 소통의 소중한 감동", isFeatured: false, accentVariant: "purple",
    },
    {
    ...
    {
      id: "mem-7", date: "2024-06-15", title: "생일 카페 이벤트",
      description: "멤버 생일 기념 카페 이벤트에 다녀왔어요. 팬들이 준비한 이벤트가 감동적이었어요.",
      tags: ["생일", "카페"], emoji: "🎂", side: "top",
      typeLabel: "이벤트 참여", mediaLabel: "특전 컵홀더 & 엽서", locationLabel: "홍대 생일 카페거리",
      reactionCount: 50, connectionLabel: "팬덤 동료들과의 만남", isFeatured: false, accentVariant: "pink",
    },
    {
