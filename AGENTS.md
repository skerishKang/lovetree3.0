...
- 상세 기준은 [AI 개발 운영정책 v2.0](docs/operations/AI_DEVELOPMENT_OPERATING_POLICY.md)을 따릅니다.
...
- 제품 방향, UX·비즈니스 결정, 위험 수용, 최종 merge·배포 승인을 담당합니다.
...
- [LoveTree 3.0 AI 개발 운영정책 v2.0](docs/operations/AI_DEVELOPMENT_OPERATING_POLICY.md)
